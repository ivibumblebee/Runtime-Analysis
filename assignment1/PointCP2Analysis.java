...
public class PointCP2Analysis {
	 ...
	 * Tests the performance of the PointCP2 class by timing the creation of PointCP2 objects
	...
	public static void main(String[] args) {
		...
		PointCP2[] points = new PointCP2[NUM_OBJECTS];
		...
		PointCP2[] points2 = new PointCP2[NUM_OBJECTS];
		for (int i = 0; i < NUM_OBJECTS; i++) {
			if (random.nextInt(2) == 0) {
				points2[i] = new PointCP2('C', random.nextFloat() * NUM_OBJECTS, random.nextFloat() * 360);
			} else {
				points2[i] = new PointCP2('P', random.nextFloat() * NUM_OBJECTS, random.nextFloat() * 360);
			}
		}
		start = System.currentTimeMillis();
		for (int i = 0; i < NUM_OBJECTS; i++) {
