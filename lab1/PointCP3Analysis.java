...
public class PointCP3Analysis {
	public static void main(String[] args) {
		...
		PointCP3[] points = new PointCP3[5000000];
		...
		PointCP3[] points2 = new PointCP3[5000000];
		for (int i = 0; i < 5000000; i++) {
			if (random.nextInt(2) == 0) {
				points2[i] = new PointCP3('C', random.nextFloat() * 5000000, random.nextFloat() * 360);
			} else {
				points2[i] = new PointCP3('P', random.nextFloat() * 5000000, random.nextFloat() * 360);
			}
		}
		start = System.currentTimeMillis();
		for (int i = 0; i < 5000000; i++) {
